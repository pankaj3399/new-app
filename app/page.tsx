              ...
              <AnimatePresence mode="wait">
                ...
                >
                  {/* 
                    ...
                    ```
                  */}
                  <div className="bg-gradient-to-r from-black to-gray-500 bg-clip-text text-transparent dark:from-white dark:to-gray-300">
                ...
                >
                  ...
                  International Employment, contractor management and more.
                </m.div>
